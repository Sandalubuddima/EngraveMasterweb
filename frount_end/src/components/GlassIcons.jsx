...
const GlassIcons = ({ items, className }) => {
  ...
  return (
    <div
      className={`grid gap-[10em] grid-cols-2 md:grid-cols-3 mx-auto py-[3em] overflow-visible ${
        className || ""
      }`}
    >
      {items.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            >
              <span
                className={`m-auto w-[2.5em] h-[2.5em] flex items-center justify-center text-3xl transition-transform duration-300 group-hover:scale-125 ${
